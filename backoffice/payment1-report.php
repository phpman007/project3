...
if (!empty($_GET['cancel'])) {
    $sql = sprintf("UPDATE payment SET status = null WHERE id = '%s'", $_GET['cancel']);
...
$sql = "SELECT * FROM payment WHERE invoiceStatus='จ่ายมัดจำ' ORDER BY id desc  limit {$start} , {$perpage} ";
