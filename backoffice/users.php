...
$sql = "SELECT * FROM tbl_users WHERE type = 'member' limit {$start} , {$perpage} ";
      ...
      <div class="content">
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card-box">
                <h4 class="m-t-0 header-title">รายการผู้เช่าทั้งหมด <small><a href="user-form.php">เพิ่ม +</a></small> </h4>
                  ...
                  <tbody>
                    ...
                    <?php while ($re = mysqli_fetch_assoc($result)) {?>
                      <tr>
                        ...
                        <td><?php echo $re['id_card'] ?></td>
                        <td>
                          <a href="user-form.php?action=edit&uid=<?php echo $re['id'] ?>" class="btn btn-sm btn-info">แก้ไข</a>
                          <a onclick="if(!confirm('ยืนยันการทำรายการ ลบข้อมูลหรือไม่')) return false" href="user-form.php?action=delete&uid=<?php echo $re['id'] ?>" class="btn btn-sm btn-danger">ลบ</a>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
